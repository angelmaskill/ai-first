...
> 业务方案：`docs/archive/AI-first-多岗位AI项目脚手架剩余工作总清单.md`
> 评审记录：`docs/archive/AI-first-剩余工作总清单-评审意见.md`（三轮）
...
本方案相对业务方案的有意变更，经评审（`docs/archive/AI-first-技术实现方案-评审意见.md`）决议如下（P0-1：把"口径分歧"升级为正式 ADR，避免两份文档打架）：
